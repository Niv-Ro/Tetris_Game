...
namespace Tetris_new
{
    ...
    public class IBlock : PositionedBlock
    {
        ...
        public override int Id => 1; //the id of the block
        protected override Position Start_Offset => new Position(-1,3); //the offset of the block
