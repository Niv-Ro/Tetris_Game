...
namespace Tetris_new
{
    ...
    public class OBlock : PositionedBlock
    {
        ...
        public override int Id =>4; //the id of the block
        protected override Position Start_Offset => new Position(0, 4); //the offset of the block
